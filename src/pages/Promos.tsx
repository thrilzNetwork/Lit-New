...
export const Promos: React.FC = () => {
  ...
  if (loading) return <div className="pt-40 text-center">Cargando promociones...</div>;
    ...
    <div className="pt-32 pb-24 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto font-light text-lg">Aprovecha nuestros descuentos especiales y packs diseñados para potenciar tu bienestar al mejor precio.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {promos.map((promo, i) => (
            ...
            >
              <div className="absolute top-0 right-0 p-8 text-lit-purple/10 group-hover:text-lit-purple/20 transition-colors">
                <Percent size={120} />
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-500 mb-8 font-light leading-relaxed">{promo.description}</p>
                
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  <div className="bg-gray-50 border-2 border-dashed border-gray-200 px-6 py-3">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <button className="bg-lit-green text-white px-10 py-4 font-bold uppercase tracking-widest text-sm hover:bg-white hover:text-lit-purple transition-all">
                Ir a la Tienda
              </button>
            </div>
          </motion.div>
